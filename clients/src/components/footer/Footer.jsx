...
const Footer = () => {
  return (
    <div className="bg-slate-800 md:mt-0 mt-10 z-20">
      <footer className="max-w-screen-xl mx-auto w-full text-slate-400">
        ...
        <div className="pt-16 pb-12 text-sm border-t border-slate-900 ">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              >
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    ...
                    >
                      +88 02 8180202 / +880 1611 777 770
                    </a>
                  </li>
                  <li className="mb-2 leading-6">
                    <a
                  ...
                  <li className="mb-2 leading-6">
                    ...
                    <a
                      ...
                      className="transition-colors duration-300 hover:text-emerald-500 focus:text-emerald-600"
                    >
                      Shah Ali Tower(6th & 7th Floor), 33 Kawran Bazar,
                      Dhaka-1215
                    </a>
                  </li>
                </ul>
              ...
              >
                <h3
                  className="mb-6 uppercase text-base font-medium text-white"
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-colors duration-300 hover:text-emerald-500 focus:text-emerald-600"
                    >
                      Tackle your to-do list wherever you are with our mobile
                      app & make your life easy.
                    </a>
                  </li>
                  <li className="mt-4 md:flex contents gap-5 mr-20">
                    <img
                      className="pb-5 w-[60%]"
                  ...
                  >
                    <h2
                      className="sr-only text-[#25a267]"
                      id="footer-social-links-dark"
                    >
                      Social Media Links
                    </h2>
                    <ul className="flex  items-center mt-2 md:mt-10 gap-6  md:gap-6">
                      <li>
                        <a
                          href="javascript:void(0)"
                        ...
                        >
                          <svg
                            ...
                            height="20"
                            width="20"
                            className="w-10 h-10 shrink-0 border border-slate-500-300  rounded-full p-2"
        ...
        {/*      <!-- Sub Footer --> */}
        <div>
          <div className="py-4 text-sm border-t border-slate-700">
            <div className="text-center">
              Copyright © 2024{" "}
              <span className="text-emerald-500">Radisson Web Team </span> | All
              Rights Reserved
            </div>
          </div>
        </div>
