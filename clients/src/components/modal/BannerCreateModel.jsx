...
function BannerCreateModal({ id }) {
  ...
  const { lodding, error,isCreateBanner} = useSelector(
  ...
  }, [dispatch,error, toast, isCreateBanner, navigate]);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createBannersAction(myfrom));
  };
