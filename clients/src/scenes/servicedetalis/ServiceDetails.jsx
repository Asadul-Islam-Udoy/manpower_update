        ...
        >
          <div className="max-w-screen-xl p-4 mx-auto">
              ...
              <div>
                <div className="flex flex-wrap items-start gap-4">
                  ...
                  <div className="flex flex-wrap gap-4 ml-auto">
                    <button
                      type="button"
                      className="px-2.5 py-1.5 bg-pink-100 text-xs text-pink-700 rounded-md flex items-center"
                    >
                      <svg
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    ...
                    type="button"
                    className="min-w-[200px] px-4 py-3 bg-[#25a267] hover:bg-gray-900 text-sm font-semibold rounded-md"
                  >
                    Book Service
                  </button>
                </div>
            ...
            <div className="w-full mt-20">
              ...
              <div>
                {activeTab == "overview" && (
                  <ServiceOverview description={singleService?.description} />
                )}
                {activeTab == "reviews" && (
