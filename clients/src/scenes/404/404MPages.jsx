...
const Error404Page = () => {
  return (
    <div>
      <div class="h-screen w-screen pt-20 md:pt-0  bg-gray-50 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700 md:mx-24">
